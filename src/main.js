		...
		<div class="w-fit xl:1/3 px-12 py-4 rounded-xl backdrop-blur-xs">
			<div class="w-full flex justify-between items-center flex-col gap-y-6">
				...
				<div class="flex w-full justify-center items-center gap-4 flex-wrap">
					<a href="https://instagram.com/z1arshia" class="text-xl sm:text-2xl flex gap-x-1 items-center bg-white/10 px-4 py-2 rounded-lg">
					...
					<a href="https://t.me/ssArshia" class="text-xl sm:text-2xl flex gap-x-1 items-center bg-white/10 px-4 py-2 rounded-lg">
				...
				<a href="tel:+989055145680" class="text-xl md:text-2xl flex gap-x-1 items-center bg-white/10 px-4 py-2 rounded-lg">
